    ...
    <section className='min-h-[42rem] bg-[url("../assets/img/overview/bg.svg")] bg-cover bg-left-top pt-[30px] lg:pt-[87px] flex justify-center items-center'>
      <div className="container mx-auto flex items-center justify-center w-full overflow-hidden bg-white rounded-t-xl shadow-lg p-8 flex-col lg:flex-row space-y-6 lg:p-14 space-x-4">
        ...
        <div className='flex flex-col justify-between space-y-8 lg:w-1/2'>
          <div>
            <h2 className='title tracking-wide'>Contact Us</h2>
          ...
          <div className='flex flex-col space-y-4'>
            ...
            <div className='inline-flex space-x-1 items-center'>
              <FiMapPin className='text-xl'></FiMapPin>
              <span className='pb-2'>Jaipur</span>
            </div>
          </div>
          <div className='flex space-x-4 text-lg'>
            <Link href='https://facebook.com/people/Systrocode/61553616951262' aria-label="Follow us on Facebook">
              <FaFacebook></FaFacebook>
            </Link>
            <Link href='https://www.linkedin.com/company/systrocode/' aria-label="Connect with us on LinkedIn">
              <FaLinkedin></FaLinkedin>
            </Link>
            <Link href='https://x.com/systrocode' aria-label="Follow us on Twitter">
              <FaTwitter></FaTwitter>
            </Link>
            <Link href='https://www.instagram.com/systrocode/' aria-label="Follow us on Instagram">
